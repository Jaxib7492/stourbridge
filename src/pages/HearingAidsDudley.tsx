          ...
          <div className="space-y-4">
            <details className="group bg-black/50 border border-gray-800 rounded-xl overflow-hidden">
              ...
              <div className="px-6 pb-6 text-gray-400">
                Symptoms include muffled hearing, a feeling of fullness in the ear, earache, or sudden tinnitus. Our Dudley team can perform a video otoscopy to show you the condition of your ear canal.
              </div>
            </details>
