...
import { CreditCard, CheckCircle2, Headphones, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="mt-12 mb-16 flex justify-center">
            <div className="w-full max-w-4xl aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-red-700/50">
              <iframe
                ...
                src="https://www.youtube.com/embed/ubYEoG1cpQg?si=ndlnO6Ci3KVQ9thw?rel=0&modestbranding=1&showinfo=0&controls=1"
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4">The Latest Discreet Technology</h2>
            <div className="h-1 w-24 bg-red-600 mx-auto"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "RIC – Rechargeable", img: "/image copy copy copy copy copy copy.png", desc: "Our most popular style. Discreet behind-the-ear design with Bluetooth and rechargeable batteries." },
              { title: "IIC – Invisible", img: "/image copy copy copy copy copy copy copy copy copy copy copy.png", desc: "Custom-made to sit deep in the ear canal. Virtually invisible to those around you." },
              { title: "CIC – Completely-in-Canal", img: "/image copy copy copy copy copy copy copy copy.png", desc: "Custom-moulded for a perfect fit. Natural sound quality with high-level discretion." },
              { title: "ITC – Rechargeable", img: "/image copy copy copy copy copy copy copy copy copy copy.png", desc: "Combines the benefits of custom in-the-ear aids with modern rechargeable technology." },
              { title: "ITE – In-the-Ear", img: "/image copy copy copy copy copy copy copy copy copy.png", desc: "Easy to handle with tactile controls. Ideal for those with dexterity concerns." },
              { title: "Bluetooth Connectivity", img: "/image copy copy copy copy copy copy copy copy copy copy copy copy.png", desc: "Stream phone calls, music, and TV audio directly to your hearing aids." }
            ].map((item, idx) => (
              <div key={idx} className="group bg-gray-900/50 rounded-2xl p-8 border border-gray-800 hover:border-red-600 transition-all duration-500">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-800 to-red-600">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-4xl font-bold mb-6 italic text-white">Lifetime Support Included</h2>
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3 justify-center md:justify-start">
                <CheckCircle2 className="text-white w-6 h-6" />
                <span className="text-lg font-medium text-white">Unlimited Fine-Tuning & Adjustments</span>
              </div>
              <div className="flex items-center gap-3 justify-center md:justify-start">
                <CheckCircle2 className="text-white w-6 h-6" />
                <span className="text-lg font-medium text-white">Walk-in Maintenance (6 Days a Week)</span>
              </div>
            </div>
            <button
              onClick={() => navigate('/contact')}
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
             <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-sm">
                ...
                <h4 className="font-bold text-white">5-Year Warranty</h4>
             </div>
             <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-sm">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900/50 border-y border-gray-800">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-b from-red-900/20 to-transparent p-12 rounded-3xl border border-red-900/50">
          ...
          <h2 className="text-4xl font-bold mb-6">Affordable Hearing for Everyone</h2>
          <p className="text-xl text-gray-300 mb-10 leading-relaxed">
            Spread the cost with <span className="text-white font-bold underline decoration-red-500">0% Interest-Free Finance</span>. 
          </p>
          <button
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-t from-red-900 to-black text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-5xl font-bold mb-6">Ready to Hear Clearly?</h2>
