...
export function EarplugsPage() {
  ...
  const productTypes = [
    ...
    },
    {
      ...
      description:
        'Custom silicone and acrylic ear mould impressions designed for industrial work, sleep, swimming, and motorsport.',
    },
    {
      icon: Volume2,
      title: 'Noise Reduction Ear Plugs',
      description:
        'Bespoke ear impressions tailored for custom noise-attenuating earplugs and precision acoustic filters.',
    },
    {
      icon: Ear,
      title: 'Other Custom-Made Ear Products',
      description:
        'Professional otoscopic ear impressions taken to exact depth requirements for any specialist ear product supplier.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        'Precision ear canal moulding conducted strictly by qualified clinical audiologists.',
    },
    {
      icon: ClipboardCheck,
      title: 'Standalone Appointment',
      description:
        'Independent service—no requirement to purchase end-products directly through our clinic.',
    },
    {
      icon: Ear,
      title: 'Suitable for Many Products',
      description:
        'Otometric impressions crafted to match specifications for all IEM and custom plug brands.',
    },
    {
      icon: Search,
      title: 'FREE Ear Check',
      description:
        'Complimentary otoscopy screening to verify ear health before inserting impression material',
    },
    {
      icon: MapPin,
      title: 'Convenient Location',
      description:
        'Centrally located High Street practice serving Dudley, Halesowen, and West Midlands.',
    },
    {
      icon: Award,
      title: 'Friendly & Professional',
      description:
        'Clinical safety protocols using otostops to safeguard the tympanic membrane..',
    },
  ];
  ...
  const processSteps = [
    {
      number: '01',
      icon: CalendarDays,
      title: 'Schedule Otoscopic Screening',
      description:
    ...
    },
    {
      ...
      description:
        'Our audiologist examines the ear canal for clear acoustic pathways and healthy eardrums.',
    },
    {
      number: '03',
      icon: Ear,
      title: 'Impression Material Placement',
      description:
    ...
    },
    {
      number: '04',
      icon: Headphones,
      title: 'Manufacturer Submission',
      description:
        'Receive your accurate, cured ear impressions ready for dispatch to your manufacturer.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'An ear impression is a professional mould or impression taken from inside the ear so that a custom-made ear product can be manufactured to fit accurately.',
    },
    {
      question: 'What products can you take ear impressions for?',
      answer:
        'We can provide professional ear impressions for products including in-ear monitors, custom shooting ear plugs, custom hearing protection, noise reduction ear plugs and other custom-made ear products.',
    },
    {
      question:
        'Do I need to purchase the custom product from Stourbridge Hearing Centre?',
      answer:
        'No. Our standalone ear impression service is ideal if you are ordering directly from third-party manufacturers. Our clinical audiologists produce high-precision otometric impressions accepted by all major custom earplug and IEM brands.',
    },
    {
      question: 'Is the ear check before the impression free?',
      answer:
        'Yes. We offer a FREE Quick Look Ear Check before your ear impression appointment. This allows us to look inside your ears and check whether they are suitable for the procedure.',
    },
    {
      question: 'Why do I need an ear check before an impression?',
      answer:
        'It is important to check that your ears and ear canals are suitable before taking an ear impression. A quick look can identify issues such as excessive earwax that could affect the ear impression process.',
    },
    {
      question: 'Where are you located?',
      answer:
        'Stourbridge Hearing Centre is located at 59 High Street, Stourbridge, DY8 1DE, in Stourbridge town centre.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <Helmet>
        <title>
          Custom Ear Impressions Stourbridge | Audiologist Earplugs
        </title>

        <meta name="description" content="HCPC-registered ear impression service in Stourbridge. Professional impressions for custom in-ear monitors, shooting plugs, and noise protection. Free ear check." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-5">
                Clinical Ear Impressions for Custom Hearing Protection & In-Ear Monitors
              </h2>

              <p className="text-red-50 text-base sm:text-lg leading-relaxed mb-5 max-w-2xl">
                At Stourbridge Hearing Centre, we provide a professional ear
                impression service for customers who require accurate
                impressions of their ears for custom-made products.
              </p>

              <p className="text-red-100 leading-relaxed mb-8 max-w-2xl">
                If you are purchasing in-ear monitors, custom shooting ear
                plugs, hearing protection or other custom-made ear products,
                we can provide the professional ear impressions required for
                your chosen supplier or manufacturer.
              </p>
                ...
                <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl min-h-[360px] sm:min-h-[430px] flex items-center justify-center overflow-hidden">
                  ...
                  <div className="text-center px-8">
                    ...
                    <p className="text-gray-400 max-w-md mx-auto leading-relaxed">
                      Accurate professional impressions for custom-made ear
                      products.
                    </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed">
              Our ear impression service is available as a standalone
              appointment. You may already know which company or supplier you
              are purchasing your custom product from and simply require
              professionally taken ear impressions.
            </p>
          ...
          <p className="text-center text-gray-500 text-sm mt-8">
            Once your ear impressions have been taken, you can use them as
            required for the custom product being made.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="relative bg-gradient-to-br from-red-700 via-red-600 to-red-800 rounded-3xl p-8 sm:p-12 overflow-hidden shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <p className="text-red-50 leading-relaxed mb-7">
                    Before taking an ear impression, it is important to check
                    that your ears and ear canals are suitable for the
                    procedure.
                  </p>
                  ...
                  <div className="bg-black/20 border border-white/20 rounded-2xl p-5">
                    ...
                    <div className="flex gap-4">
                      ...
                      <p className="text-white text-sm sm:text-base leading-relaxed">
                        We offer a FREE Quick Look Ear Check before your ear
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-6">
                Otoscopic Examination Prior to Ear Moulding
              </h2>

              <p className="text-gray-400 leading-relaxed mb-5">
                At Stourbridge Hearing Centre, we offer a FREE Quick Look Ear
                Check before your ear impression appointment.
              </p>

              <p className="text-gray-400 leading-relaxed mb-8">
                Using specialist equipment, we can take a quick look inside
                your ears to check for issues such as excessive earwax that
                could affect the ear impression process.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 p-5 bg-gray-900 rounded-2xl border border-gray-800 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      We check your ears and ear canals to assess whether they
                ...
                <div className="flex gap-4 p-5 bg-gray-900 rounded-2xl border border-gray-800 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      We can check for issues such as excessive earwax that
                      could affect the ear impression process.
                    </p>
                ...
                <div className="flex gap-4 p-5 bg-red-950/40 rounded-2xl border border-red-900/50">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      If your ears are suitable, we can proceed with arranging
                      or carrying out your ear impression service.
                    </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              A professional ear impression service designed around accuracy,
              convenience and your comfort.
            </p>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-b from-gray-900 to-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              From your FREE Quick Look Ear Check through to your professional
              ear impression.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-5">
                  Already Know Which Custom Product You Want?
                </h2>

                <p className="text-gray-400 leading-relaxed mb-5">
                  Our ear impression service is available as a standalone
                  appointment. You may already know which company or supplier
                  you are purchasing your custom product from and simply
                  require professionally taken ear impressions.
                </p>
              ...
              <div className="bg-gray-950 rounded-2xl border border-gray-800 p-7 shadow-xl">
                ...
                <h3 className="text-xl font-bold text-white mb-5">
                  We can provide impressions for:
                </h3>
                ...
                <ul className="space-y-4">
                  ...
                  {[
                    ...
                    'Other custom-made ear products',
                  ].map((item) => (
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900 rounded-3xl border border-gray-800 p-8 sm:p-10 shadow-xl">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-4">
                Visit Our Stourbridge Audiology Practice
              </h2>

              <p className="text-gray-400 leading-relaxed mb-6">
                Our independent clinical ear impression service operates directly from our High Street practice in Stourbridge town centre.
              </p>
            ...
            <div className="bg-black rounded-3xl border border-gray-800 p-8 sm:p-10 text-white shadow-2xl">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-4">
                Book Your Clinical Ear Impression Appointment
              </h2>

              <p className="text-gray-400 leading-relaxed mb-8">
                We advise arranging a preliminary otoscopic check to ensure your ear canals are clear of earwax prior to impression taking.
              </p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-700 via-red-600 to-red-800">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-5">
            Book Custom Ear Impressions at Our Stourbridge Practice
          </h2>

          <p className="text-red-50 text-lg sm:text-xl leading-relaxed max-w-3xl mx-auto mb-9">
            If you require clinical ear impressions for custom-moulded IEMs, shooting plugs, or acoustic hearing protection, Stourbridge Hearing Centre provides expert audiological care.
          </p>

          <p className="text-white/90 mb-9">
            Contact our HCPC-registered team today to schedule your complimentary otoscopic check and ear moulding session.
          </p>
