  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <Helmet>
        ...
        <meta name="description" content="Expert hearing aids and microsuction ear wax removal services in Wolverhampton. Professional ear care, free hearing tests, and urgent appointments available." />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
        <div className="max-w-4xl mx-auto text-gray-300 text-lg leading-relaxed space-y-6">
          ...
          <p>
            As an independent, audiologist-led clinic, we travel beyond simple retail. We provide comprehensive diagnostic hearing assessments 
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-red-500 transition-all group shadow-lg">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              and performed by clinical experts to ensure maximum comfort and safety.
            </p>
          </div>
          ...
          <div className="bg-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-red-500 transition-all group shadow-lg">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              rechargeable hearing aids from leading global manufacturers.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 text-sm">Highly rated hearing care across the Black Country.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <details className="group bg-black/50 border border-gray-800 rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="px-6 pb-6 text-gray-400">
                No, you can book directly with us for both hearing tests and ear wax removal without needing a referral from your doctor.
              </div>
            </details>
          </div>
        </div>
