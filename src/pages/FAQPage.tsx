...
export function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* SEO Metadata */}
      <Helmet>
        <title>Frequently Asked Questions | Stourbridge Hearing Centre</title>
        <meta name="description" content="Find answers to common questions about hearing tests, microsuction ear wax removal, and hearing aid technology in Stourbridge and the West Midlands." />
