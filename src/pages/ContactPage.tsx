...
export function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* SEO Metadata */}
      <Helmet>
        <title>Contact Us | Stourbridge Hearing Centre | Book an Appointment</title>
        <meta name="description" content="Contact Stourbridge Hearing Centre for expert audiology services. Book a free hearing test, earwax removal, or hearing aid repair. Located on Stourbridge High Street." />
