...
export function AftercarePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* SEO Metadata */}
      <Helmet>
        <title>Hearing Aid Aftercare & Support Stourbridge | Lifetime Maintenance</title>
        <meta name="description" content="Benefit from lifetime hearing aid aftercare at Stourbridge Hearing Centre. We offer free walk-in cleaning, professional fine-tuning, and routine earwax checks." />
